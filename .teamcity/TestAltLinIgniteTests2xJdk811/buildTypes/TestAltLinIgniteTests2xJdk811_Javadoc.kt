...
object TestAltLinIgniteTests2xJdk811_Javadoc : BuildType({
    name = "[Javadoc]"
    ...
    steps {
        ...
        maven {
            ...
            runnerArgs = """
                ...
                -DskipTests
                ${TestAltLinIgniteTests2xJdk811_BuildApacheIgnite.depParamRefs["MAVEN_MODULES_STRING"]}
            """.trimIndent()
            mavenVersion = custom {
    ...
    dependencies {
        snapshot(TestAltLinIgniteTests2xJdk811_BuildApacheIgnite) {
        }
    }
