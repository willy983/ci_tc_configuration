...
object TestAltLinIgniteTests2xJdk811_RunTestSuitesJavaOld : Template({
    ...
    params {
        ...
        text("JVM_EXTRA_ARGS", "${TestAltLinIgniteTests2xJdk811_BuildApacheIgnite.depParamRefs["JVM_EXTRA_ARGS"]}", display = ParameterDisplay.HIDDEN, allowEmpty = true)
        ...
        text("ACTUAL_VERSION", "${TestAltLinIgniteTests2xJdk811_BuildApacheIgnite.depParamRefs["ACTUAL_VERSION"]}", display = ParameterDisplay.HIDDEN, allowEmpty = true)
