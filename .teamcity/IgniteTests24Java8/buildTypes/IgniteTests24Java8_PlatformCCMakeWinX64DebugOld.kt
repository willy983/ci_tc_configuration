...
object IgniteTests24Java8_PlatformCCMakeWinX64DebugOld : BuildType({
        ...
        powerShell {
            ...
            scriptMode = script {
                content = """
                    ...
                    Foreach-object IgniteTests24Java8_{
