...
object IgniteTests24Java8_SpiUriDeployOld : BuildType({
    templates(IgniteTests24Java8_RunTestSuitesJavaOld)
    name = "~[DEPRECATED] SPI (URI Deploy)"
    ...
    params {
        param("MAVEN_MODULES", ":ignite-urideploy")
        param("TEST_SUITE", "IgniteUriDeploymentTestSuite")
    }
