...
object IgniteTests24Java8_CassandraStoreOld : BuildType({
    templates(IgniteTests24Java8_RunTestSuitesJavaOld)
    name = "~[DEPRECATED] Cassandra Store"
    ...
    params {
        param("MAVEN_MODULES", ":ignite-cassandra-store")
        param("TEST_SUITE", "IgniteCassandraStoreTestSuite")
    }
