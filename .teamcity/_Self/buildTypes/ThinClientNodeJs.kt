...
object ThinClientNodeJs : BuildType({
    templates(RelativeId("ThirdpartyCheckout"), RelativeId("PreBuild"), AbsoluteId("RunNodeJsTests"), RelativeId("PostBuild"))
    ...
    vcs {
        root(AbsoluteId("GitHubApacheIgniteNodejsThinClient"), "+:. => %VCS_ROOT_NODEJS%")
