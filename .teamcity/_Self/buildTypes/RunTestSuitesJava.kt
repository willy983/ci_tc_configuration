...
object RunTestSuitesJava : Template({
    ...
    params {
        ...
        text("JVM_EXTRA_ARGS", "${BuildApacheIgnite.depParamRefs["JVM_EXTRA_ARGS"]}", display = ParameterDisplay.HIDDEN, allowEmpty = true)
