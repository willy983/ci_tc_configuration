...
object WiPPlatformCCMakeWinX64Release : BuildType({
    templates(RunTestSuitesJava, C)
    ...
    params {
        param("env.BOOST_LIBRARYDIR", """%env.BOOST_HOME%\lib64-msvc-14.1""")
    ...
    disableSettings("RQ_10", "RQ_14", "RUNNER_265", "RUNNER_266")
})
