...
object WiPThinClientPython : BuildType({
    templates(RelativeId("ThirdpartyCheckout"), RelativeId("PreBuild"), AbsoluteId("RunPythonTestsBasic"), AbsoluteId("RunPythonTestsSsl"), RelativeId("PostBuild"))
