...
object ThinClientNodeJsOld : BuildType({
    templates(RelativeId("ExcludeTests"), RelativeId("PreBuild"), AbsoluteId("ThinClientStartIgnite"), AbsoluteId("ThinClientStopIgnite"), RelativeId("PostBuild"))
    ...
    params {
        ...
        text("ACTUAL_VERSION", "${BuildApacheIgnite.depParamRefs["ACTUAL_VERSION"]}", display = ParameterDisplay.HIDDEN, allowEmpty = true)
        param("SKIP_BUILD_CONDITION", """! -d "modules/platforms/nodejs"""")
    }
