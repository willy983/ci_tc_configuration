...
object TestAltLinIgniteTests24Java8_RunTestSuitesJavaOld : Template({
    ...
    params {
        ...
        text("JVM_EXTRA_ARGS", "${TestAltLinIgniteTests24Java8_BuildApacheIgnite.depParamRefs["JVM_EXTRA_ARGS"]}", display = ParameterDisplay.HIDDEN, allowEmpty = true)
        ...
        text("ACTUAL_VERSION", "${TestAltLinIgniteTests24Java8_BuildApacheIgnite.depParamRefs["ACTUAL_VERSION"]}", display = ParameterDisplay.HIDDEN, allowEmpty = true)
    ...
    dependencies {
        dependency(TestAltLinIgniteTests24Java8_BuildApacheIgnite) {
            snapshot {
