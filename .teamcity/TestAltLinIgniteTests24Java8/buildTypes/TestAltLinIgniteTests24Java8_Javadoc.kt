...
object TestAltLinIgniteTests24Java8_Javadoc : BuildType({
    name = "[Javadoc]"
    ...
    steps {
        ...
        maven {
            ...
            runnerArgs = """
                ...
                -DskipTests
                ${TestAltLinIgniteTests24Java8_BuildApacheIgnite.depParamRefs["MAVEN_MODULES_STRING"]}
            """.trimIndent()
            mavenVersion = custom {
    ...
    dependencies {
        snapshot(TestAltLinIgniteTests24Java8_BuildApacheIgnite) {
        }
    }
