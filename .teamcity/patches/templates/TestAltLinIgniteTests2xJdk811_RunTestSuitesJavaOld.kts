...
To apply the patch, create a template with id = 'TestAltLinIgniteTests2xJdk811_RunTestSuitesJavaOld'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), Template({
    id("TestAltLinIgniteTests2xJdk811_RunTestSuitesJavaOld")
    ...
    params {
        ...
        text("JVM_EXTRA_ARGS", "%dep.TestAltLinIgniteTests2xJdk811_BuildApacheIgnite.JVM_EXTRA_ARGS%", display = ParameterDisplay.HIDDEN, allowEmpty = true)
        ...
        text("ACTUAL_VERSION", "%dep.TestAltLinIgniteTests2xJdk811_BuildApacheIgnite.ACTUAL_VERSION%", display = ParameterDisplay.HIDDEN, allowEmpty = true)
    ...
    dependencies {
        dependency(RelativeId("TestAltLinIgniteTests2xJdk811_BuildApacheIgnite")) {
            snapshot {
