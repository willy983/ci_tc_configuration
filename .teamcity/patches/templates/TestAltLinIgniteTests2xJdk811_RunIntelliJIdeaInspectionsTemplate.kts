...
To apply the patch, create a template with id = 'TestAltLinIgniteTests2xJdk811_RunIntelliJIdeaInspectionsTemplate'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), Template({
    id("TestAltLinIgniteTests2xJdk811_RunIntelliJIdeaInspectionsTemplate")
