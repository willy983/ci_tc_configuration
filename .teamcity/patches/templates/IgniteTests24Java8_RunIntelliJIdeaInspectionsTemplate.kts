...
To apply the patch, change the template with id = 'IgniteTests24Java8_RunIntelliJIdeaInspectionsTemplate'
accordingly, and delete the patch script.
*/
changeTemplate(RelativeId("IgniteTests24Java8_RunIntelliJIdeaInspectionsTemplate")) {
    expectSteps {
        script {
