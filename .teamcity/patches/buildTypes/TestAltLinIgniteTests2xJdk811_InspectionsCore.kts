...
To apply the patch, create a buildType with id = 'TestAltLinIgniteTests2xJdk811_InspectionsCore'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), BuildType({
    templates(RelativeId("TestAltLinIgniteTests2xJdk811_RunIntelliJIdeaInspectionsTemplate"))
    id("TestAltLinIgniteTests2xJdk811_InspectionsCore")
