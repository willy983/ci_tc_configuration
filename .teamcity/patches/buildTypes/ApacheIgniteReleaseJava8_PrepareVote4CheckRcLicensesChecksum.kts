...
To apply the patch, create a buildType with id = 'ApacheIgniteReleaseJava8_PrepareVote4CheckRcLicensesChecksum'
...
create(RelativeId("Releases_ApacheIgniteMain"), BuildType({
    id("ApacheIgniteReleaseJava8_PrepareVote4CheckRcLicensesChecksum")
