...
To apply the patch, create a buildType with id = 'ApacheIgniteReleaseJava8_PrepareVote3BuildNuGetPackages'
...
create(RelativeId("Releases_ApacheIgniteMain"), BuildType({
    id("ApacheIgniteReleaseJava8_PrepareVote3BuildNuGetPackages")
