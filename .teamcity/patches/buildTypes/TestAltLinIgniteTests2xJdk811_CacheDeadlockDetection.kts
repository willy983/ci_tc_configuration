...
To apply the patch, create a buildType with id = 'TestAltLinIgniteTests2xJdk811_CacheDeadlockDetection'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), BuildType({
    ...
    id("TestAltLinIgniteTests2xJdk811_CacheDeadlockDetection")
