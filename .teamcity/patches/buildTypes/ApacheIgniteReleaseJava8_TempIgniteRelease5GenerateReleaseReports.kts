...
To apply the patch, create a buildType with id = 'ApacheIgniteReleaseJava8_TempIgniteRelease5GenerateReleaseReports'
...
create(RelativeId("Releases_ApacheIgniteMain"), BuildType({
    id("ApacheIgniteReleaseJava8_TempIgniteRelease5GenerateReleaseReports")
