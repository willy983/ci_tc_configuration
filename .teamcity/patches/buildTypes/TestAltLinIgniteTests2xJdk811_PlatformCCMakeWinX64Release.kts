...
To apply the patch, create a buildType with id = 'TestAltLinIgniteTests2xJdk811_PlatformCCMakeWinX64Release'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), BuildType({
    templates(RelativeId("TestAltLinIgniteTests2xJdk811_C"), RelativeId("TestAltLinIgniteTests2xJdk811_RunTestsJava"), RelativeId("TestAltLinIgniteTests2xJdk811_RunNodeLibs"))
    id("TestAltLinIgniteTests2xJdk811_PlatformCCMakeWinX64Release")
