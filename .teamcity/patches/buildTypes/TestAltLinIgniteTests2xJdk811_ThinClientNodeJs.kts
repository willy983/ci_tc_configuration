...
To apply the patch, create a buildType with id = 'TestAltLinIgniteTests2xJdk811_ThinClientNodeJs'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), BuildType({
    templates(RelativeId("TestAltLinIgniteTests2xJdk811_ThirdpartyCheckout"), RelativeId("TestAltLinIgniteTests2xJdk811_PreBuild"), RelativeId("RunNodeJsTests"), RelativeId("TestAltLinIgniteTests2xJdk811_PostBuild"))
    id("TestAltLinIgniteTests2xJdk811_ThinClientNodeJs")
    ...
    vcs {
        root(RelativeId("GitHubApacheIgniteNodejsThinClient"), "+:. => %VCS_ROOT_NODEJS%")
