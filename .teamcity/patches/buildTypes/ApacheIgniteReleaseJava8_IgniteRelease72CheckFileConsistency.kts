...
To apply the patch, create a buildType with id = 'ApacheIgniteReleaseJava8_IgniteRelease72CheckFileConsistency'
...
create(RelativeId("Releases_ApacheIgniteMain"), BuildType({
    id("ApacheIgniteReleaseJava8_IgniteRelease72CheckFileConsistency")
