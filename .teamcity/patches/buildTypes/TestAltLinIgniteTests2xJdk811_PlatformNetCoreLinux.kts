...
To apply the patch, create a buildType with id = 'TestAltLinIgniteTests2xJdk811_PlatformNetCoreLinux'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), BuildType({
    templates(RelativeId("TestAltLinIgniteTests2xJdk811_PreBuild"), RelativeId("TestAltLinIgniteTests2xJdk811_PostBuild"))
    id("TestAltLinIgniteTests2xJdk811_PlatformNetCoreLinux")
