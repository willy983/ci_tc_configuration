...
To apply the patch, create a buildType with id = 'TestAltLinIgniteTests2xJdk811_PlatformCCMakeWinX64Debug'
...
create(RelativeId("TestAltLinIgniteTests2xJdk811"), BuildType({
    ...
    id("TestAltLinIgniteTests2xJdk811_PlatformCCMakeWinX64Debug")
